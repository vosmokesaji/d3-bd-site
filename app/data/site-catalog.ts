...
export const BUILD_CATALOG: BuildEntry[] = [
  ...
  { id: "rathma-aotd", classId: "necromancer", name: "拉斯玛亡者大军", set: "拉斯玛之骨", core: "亡者大军", image: "/d3/library/skills/necromancer-active-army-of-the-dead.png", role: "冲层", difficulty: "高", summary: "宠物攻击压缩亡者大军冷却，在控制窗口集中释放。", complete: true },
